...
static LaserSlamWorkerParams getLaserSlamWorkerParams(const ros::NodeHandle& nh,
  ...
  nh.getParam(ns + "/distance_to_consider_fixed", params.distance_to_consider_fixed); //not set
  nh.getParam(ns + "/separate_distant_map", params.separate_distant_map); //not set
  nh.getParam(ns + "/create_filtered_map", params.create_filtered_map);
  nh.getParam(ns + "/minimum_distance_to_add_pose", params.minimum_distance_to_add_pose); //not set
  nh.getParam(ns + "/voxel_size_m", params.voxel_size_m);  //not set
  nh.getParam(ns + "/minimum_point_number_per_voxel", params.minimum_point_number_per_voxel);  //not set


  nh.getParam(ns + "/remove_ground_from_local_map", params.remove_ground_from_local_map);  //not set
  nh.getParam(ns + "/ground_distance_to_robot_center_m", params.ground_distance_to_robot_center_m);  //not set
